...
- [ ] **Database:** เขียน SQL/Logic ดึงข้อมูลจากตาราง `showtimes`, `movies`, `cinemas` ตามคำค้นหา
- [ ] **Integration:** เขียนโค้ดดักจับว่า ถ้า AI ขอเรียกใช้ Function ให้เราเอาผลลัพธ์จาก DB ส่งกลับไปให้มันประมวลผล
- [ ] **Testing:** ทดสอบถามรอบฉายหนังจริง (เช่น "วันนี้มีสัปเหร่อ 2 ฉายที่ลาดพร้าวกี่โมง?") และเช็กความถูกต้อง

*🎉 --- พักเบรก เสาร์-อาทิตย์ (7-8 มี.ค.) --- 🎉*

## 🟧 Phase 3: ขัดเกลาความฉลาดและดักบั๊ก (Prompt & Error Handling)
**📅 Day 6-7 (จันทร์ 9 - อังคาร 10 มี.ค.)**
- [ ] **Prompt Engineering:** เขียน `System Prompt` สวมบทบาทให้ AI เป็นพนักงาน Minor Cineplex ที่สุภาพและเชี่ยวชาญ
- [ ] **Guardrails:** เขียนดักทาง AI ไม่ให้ตอบคำถามนอกเรื่อง (เช่น ถามสูตรอาหาร หรือเรื่องการเมือง ให้ปฏิเสธอย่างสุภาพ)
- [ ] **Error Handling:** จัดการกรณี API ล่ม, เน็ตหลุด, หรือค้นหาหนังไม่เจอ ให้ UI แสดงข้อความ Error ที่สวยงามและไม่แครช

## 🟥 Phase 4: ประกอบร่างและเตรียม Merge (Finalize)
**📅 Day 8-9 (พุธ 11 - พฤหัส 12 มี.ค.)**
- [ ] **Integration Test:** นำ `ChatBox` Component ไปแปะไว้ที่มุมขวาล่างของหน้า Landing Page
- [ ] **Refactoring:** จัดระเบียบโค้ด, ตรวจสอบ TypeScript Types ให้เป๊ะ, และลบคอมเมนต์ที่ไม่จำเป็น
- [ ] **Documentation:** อัปเดตไฟล์ README หรือเตรียมอธิบายให้เพื่อนในทีมฟังว่าบอททำงานยังไง
