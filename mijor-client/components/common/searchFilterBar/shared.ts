...
export const selectClass =
  "flex-1 basis-0 min-w-0 !w-full py-[12px] pl-[16px] pr-[12px] bg-brand-gray-100 text-white text-body-2 cursor-pointer border border-brand-gray-200 rounded-[4px] focus:border-brand-gray-300 focus:outline-none transition-all active:scale-[0.98]";
